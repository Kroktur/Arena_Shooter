...
{
public:
	Fireball(KT::IComposite<IGameObject, Demo::ArenaShooterGameState>* owner, const Ogre::Vector3& pos, const Ogre::Vector3& dir) :
		KT::CompositeCRTP<Fireball, IGameObject, Demo::ArenaShooterGameState>(owner),
		m_direction(dir), m_pos(pos), m_speed(500.0f)
	{
	}
