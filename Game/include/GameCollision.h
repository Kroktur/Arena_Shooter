...
namespace Collision
{
	...
	void Resolve(Fireball& wall, Wall& wall2, solver solver);
	void Resolve(Fireball& wall, Fox& wall2, solver solver);
	void Resolve(Fireball& wall, MapTile& wall2, solver solver);
}
